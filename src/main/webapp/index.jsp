      		...
      		<h1>Login</h1>
      		 <fieldset>
         		 <form action="login" method="post" name="form">                
                  	 ...
                  	 <input name="username" id="user"  type="text" value="" placeholder="E-mail"
                                value="Usuário" onBlur="if(this.value=='')this.value='Email'" onFocus="if(this.value=='Email')this.value='' "/>
